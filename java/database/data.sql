...
INSERT INTO video_game (title, release_date, release_price, description, publisher_id, rating, box_art) VALUES('Guardians of Middle-earth','2012-12-04', 14.99,'Guardians of Middle-earth is a multiplayer online battle arena (MOBA) video game developed by Monolith Productions and published by Warner Bros. Interactive Entertainment. Released in 2012, the game is set in J.R.R. Tolkiens rich and beloved fantasy universe of Middle-earth, made famous by The Lord of the Rings and The Hobbit novels',39, 'T', 'https://upload.wikimedia.org/wikipedia/en/thumb/9/95/Guardians_of_MIddle-Earth_cover_art.jpg/220px-Guardians_of_MIddle-Earth_cover_art.jpg');     --40
